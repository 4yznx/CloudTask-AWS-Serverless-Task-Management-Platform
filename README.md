...
**Least Privilege Access:** All backend AWS Lambda functions are strictly bound to IAM execution roles that allow data manipulation _only_ within the specific `cloudtask-db` table ARN.
